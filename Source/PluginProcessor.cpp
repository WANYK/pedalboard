...
//ustawienie mozliwosci odczytu (wejscia) stereo
        .withInput("Input", AudioChannelSet::stereo(), true)
#endif
//ustawienie mozliwosci wyjscia mono
...
//==============================================================================
//Przygotowuje odtwarzacz audio do odtwarzania, wstępnie ładując jego bufory.
void ChorusAudioProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
    const double smoothTime = 1e-3;
//resetuje kazdy parametr
...
{
    float out = 0.0f;
//zalezy od kształtu wyliczamy z odpowiedzniego wzoru wyjście
    switch (waveform) {
//kształt sinusoidy
    case waveformSine: {
